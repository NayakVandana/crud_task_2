              ...
              <div class="card mt-3" style="padding: 20px;">
                  <form method="POST" action="/products/{{$product->id}}/update">
                     ...
                     <div class="form-group">
                        ...
                        <input class="form-control" type="number" id="price" name="price" step="0.01" value="{{ old('price',$product->price)}}">
                     ...
                     <div class="form-group">
                       ...
                       <input class="form-control" type="number" id="discount" name="discount" step="0.01" min="0" max="100" value="{{ old('discount',$product->discount)}}">
